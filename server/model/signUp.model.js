...
exports.signUpGoogle = function (user) {
    try{
       let sql = "INSERT INTO users (role_id, name, nickname, photo ,email, password, tag_id) VALUES (?,?,?,?,?,?,?)";
       let values = [2,user.name,user.nickname,user.photo,user.email,user.password,1]
