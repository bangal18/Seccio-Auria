...
export class SignUpComponent implements OnInit {
  ...
  initForm() : any{
    return this.formBuilder.group({
      nickname: ['',[Validators.required, Validators.minLength(2), Validators.pattern(/^(?=.*[a-z])[a-zA-Z\d_]{2,}$/) ] ],
      name : ['Kahiye',[Validators.required, Validators.minLength(2), Validators.pattern(/^(?=.*[a-z])[a-zA-Z\d_]{2,}$/)] ],
